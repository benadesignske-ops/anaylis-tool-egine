...
export function LiveTradingPanel({ theme, balance, currency }: LiveTradingPanelProps) {
  ...
  const { connectionStatus, currentPrice, ws, accountInfo } = useDeriv() // Added ws and accountInfo from useDeriv
  const isLoggedIn = connectionStatus === "connected"
        ...
        <div className="sticky top-0 p-4 border-b border-blue-500/20 bg-gradient-to-r from-blue-600/10 to-purple-600/10 backdrop-blur-sm">
          ...
          <div className="grid grid-cols-3 gap-2 text-xs">
            ...
            <div className={theme === "dark" ? "text-gray-300" : "text-gray-700"}>
              ...
              <div className={theme === "dark" ? "text-gray-400" : "text-gray-600"}>{accountInfo?.type || "—"}</div>
            </div>
            <div className={theme === "dark" ? "text-gray-300" : "text-gray-700"}>
